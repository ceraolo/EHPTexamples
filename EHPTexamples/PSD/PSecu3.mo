...
model PSecu3 "Full Power Split Device power train using Map-Based components"
  ...
  EHPTlib.MapBased.ECUs.PsdEcu3 ECU(genLoopGain = 1.0, socRef = 0.65) annotation (
  ...
  EHPTlib.MapBased.OneFlangeConn gen annotation (Placement(visible=true,
...
equation
  ...
  connect(gen.pin_p, bat.p) annotation (
    Line(points={{-38,22.6},{-22,22.6},{-22,10}},                  color = {0, 0, 255}));
  ...
  connect(gen.conn, ECU.conn) annotation (
    Line(points={{-57,11.98},{-57,-20},{-12,-20},{-12,-32.18}},         color = {255, 204, 51}, thickness = 0.5));
  ...
  connect(ice.conn, ECU.conn) annotation (
    Line(points={{-88,46.2},{-88,-20},{-12,-20},{-12,-32.18}},                       color = {255, 204, 51}, thickness = 0.5));
